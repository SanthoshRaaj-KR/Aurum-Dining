  ...
  useEffect(() => {
    ...
    const fetchOrderDetails = async () => {
      ...
      try {
        ...
        const response = await fetch(`${import.meta.env.VITE_TAKEAWAY_SERVICE_URL}/api/takeaway/${orderId}`);
        ...
        // Map the data from your backend format to the expected format in the component
        const formattedData = {
